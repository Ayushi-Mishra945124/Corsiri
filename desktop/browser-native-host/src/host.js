...
const PORT = Number(process.env.CORSIRI_EXTENSION_BRIDGE_PORT || process.env.CURSIVIS_EXTENSION_BRIDGE_PORT || 48830);
const REQUEST_TIMEOUT_MS = Number(process.env.CORSIRI_EXTENSION_BRIDGE_TIMEOUT_MS || process.env.CURSIVIS_EXTENSION_BRIDGE_TIMEOUT_MS || 30000);
const EXTENSION_POLL_TIMEOUT_MS = Number(process.env.CORSIRI_EXTENSION_POLL_TIMEOUT_MS || process.env.CURSIVIS_EXTENSION_POLL_TIMEOUT_MS || 25000);
const EXTENSION_STALE_AFTER_MS = Number(process.env.CORSIRI_EXTENSION_STALE_AFTER_MS || process.env.CURSIVIS_EXTENSION_STALE_AFTER_MS || 45000);
