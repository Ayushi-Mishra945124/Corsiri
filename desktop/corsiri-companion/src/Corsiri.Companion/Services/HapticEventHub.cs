...
public sealed class HapticEventHub : IDisposable
{
    ...
    public HapticEventHub(string prefix = "http://127.0.0.1:48712/corsiri-haptics/")
    {
        _listener.Prefixes.Add(prefix);
        if (!prefix.Contains("cursivis-haptics"))
        {
            _listener.Prefixes.Add("http://127.0.0.1:48712/cursivis-haptics/");
        }
    }
