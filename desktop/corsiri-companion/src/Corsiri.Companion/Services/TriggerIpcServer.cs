...
public sealed class TriggerIpcServer : IDisposable
{
    ...
    public TriggerIpcServer(string prefix = "http://127.0.0.1:48711/corsiri-trigger/")
    {
        _listener.Prefixes.Add(prefix);
        if (!prefix.Contains("cursivis-trigger"))
        {
            _listener.Prefixes.Add("http://127.0.0.1:48711/cursivis-trigger/");
        }
    }
